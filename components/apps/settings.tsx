...
export default function Settings() {
  ...
  return (
    <div className="flex h-full bg-white dark:bg-gray-900 text-black dark:text-white">
      {/* Sidebar */}
      <div className="w-64 bg-gray-100 dark:bg-gray-800 p-2">
              ...
              <div>
                ...
                <div className="bg-gray-100 dark:bg-gray-800 p-4 rounded-lg">
                  <div className="flex items-center justify-between mb-3">
                    ...
                    <select className="px-3 py-1 border rounded bg-white dark:bg-gray-700 dark:border-gray-600">
            ...
            <div className="space-y-6">
              <div>
                ...
                <div className="flex space-x-4">
                  <div className="border-2 border-blue-500 p-1 rounded-lg">
                    ...
                    <p className="text-center mt-2 font-medium dark:text-gray-200">
                      Light
                    </p>
                  </div>

                  <div className="border-2 border-gray-300 dark:border-gray-600 p-1 rounded-lg">
              ...
              <div>
                ...
                <div className="flex space-x-3">
                  {["blue", "purple", "pink", "red", "orange", "green"].map(
                    (color) => (
                      <div
                        key={color}
              ...
              <div>
                ...
                <div className="flex space-x-3">
                  {["blue", "yellow", "green", "orange", "red"].map(
                    (color) => (
                      <div
                        key={color}
                        className={`w-8 h-8 rounded-full bg-${color}-500 border-2 border-gray-300 dark:border-gray-600`}
